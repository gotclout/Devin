...
bool is_symetric()
{
  //for each vertex in A is there a path to all other verticies?
  //if so edge transitivity is true
  //transpose A
  //for each vertex in A^T is there a path to all other verticies?
  //if so vertex transitive
  //if vertex transitive and edge transitive
  return true
}
